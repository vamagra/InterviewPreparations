...
namespace InterviewPreparations.LeetCode
{
    ...
    // * sub-stack.
    //  </summary>
    class SetOfStacksPlates_CTCI
    {
        // https://jitingxu.wordpress.com/2013/08/20/3-3-magine-a-literal-stack-of-plates-if-the-stack-gets-too-high-it-might-topple-there-fore-in-real-life-we-would-likely-start-a-new-stack-when-the-previous-stack-exceeds-some-threshold-implem/

        List<Stack> listStack;
        int thresHold;

        SetOfStacksPlates_CTCI(int limit)
        {
