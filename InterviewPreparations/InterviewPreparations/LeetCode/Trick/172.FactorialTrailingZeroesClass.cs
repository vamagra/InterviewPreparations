...
{
    class FactorialTrailingZeroesClass
    {

        // Given an integer n, return the number of trailing zeroes in n!.
        // Note: Your solution should be in logarithmic time complexity.

        #region Solution Explnation
        /// <summary>
        // The idea is: Simple
        ...
        // we'll have way more than enough even numbers to pair with them to get factors of 10
        ...
        // <returns></returns>
        #endregion
        public static int CountFactorialTrailingZero(int n)
        {
            int count = 0;
