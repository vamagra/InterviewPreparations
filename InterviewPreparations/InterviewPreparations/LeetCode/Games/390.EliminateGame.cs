...
namespace InterviewPreparations.LeetCode
{
    class EliminateGame
    {
        ...
        //  number afterward until you reach the end of the list. Repeat the previous step again, but this time from right to left, 
        ...
        public static int lastRemaining(int n)
        {
            ...
            while (n > 1)
            {
                ...
                // step will be twice in every turn of loop
                step = step * 2;

                // half the list of numbers
                n = n / 2;

                //flip the left on every turn of loop
                left = !left;
            }
